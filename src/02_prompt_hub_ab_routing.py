...
PROMPT_V1_NAME = "danghoanghai-rag-prompt-v1"   # ví dụ: "nguyen-rag-v1"
PROMPT_V2_NAME = "danghoanghai-rag-prompt-v2"   # ví dụ: "nguyen-rag-v2"
...
SYSTEM_V1 = f'''Bạn là trợ lý AI hữu ích. Chỉ dùng context sau để trả lời.
          Giữ câu trả lời ngắn gọn (2-4 câu). Nếu không có thông tin, hãy nói "Không có thông tin trong context".'''
...
SYSTEM_V2 = f'''Bạn là chuyên gia AI. Đọc kỹ context, xác định facts liên quan, viết câu trả lời rõ ràng và có tổ chức (3-5 câu). Chỉ dùng thông tin từ context để trả lời. Nếu không có thông tin, hãy nói "Không có thông tin trong context".'''
