...
class PIIDetector(Validator):
    ...
    def validate(self, value: str, metadata: dict):
        ...
        if found_pii:
            ...
            # Trả về FailResult với fix_value để kích hoạt OnFailAction.FIX
            return FailResult(error_message="Found PII", fix_value=redacted_text)
...
class JSONFormatter(Validator):
    ...
    def validate(self, value: str, metadata: dict):
        ...
        try:
            ...
            # Trả về FailResult với fix_value để kích hoạt OnFailAction.FIX
            return FailResult(error_message="Invalid JSON, repaired", fix_value=json.dumps(parsed, indent=2))
